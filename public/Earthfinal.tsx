...
export default function Model({ ...props }: JSX.IntrinsicElements['group']) {
  ...
  const { nodes, materials } = useGLTF('/earthfinal-transformed.glb') as GLTFResult
  return (
    <group ref={group} {...props} dispose={null}>
      ...
      <mesh geometry={nodes.earth_color_10K001.geometry} material={materials.clouds} position={[0.16, 0.39, -0.1]} rotation={[0.55, 1.03, -0.61]} scale={0.87} />
    </group>
  )
}

useGLTF.preload('/earthfinal-transformed.glb')
